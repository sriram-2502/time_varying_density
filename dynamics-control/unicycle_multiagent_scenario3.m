function [x_dot, u, isgoal, unicycle, discrete] = unicycle_multiagent_scenario3(deltaT, x, ctrl_multiplier, gradDensityHandles, c1, c2, c3, p, single_int_p, agent_number, dens_bool)
    ...
    if dens_bool
        ...
        if norm(x - xd) < rad_from_goal
            ...
            u_hat = ctrl_multiplier * grad_density(x, c1, c2, c3);
        end
    else
