function navigation = get_density_joint2(navigation_params, joint_obs, use_motion_plan)
%% Problem setup
...
density_params.alpha = 1e-1; % Best value 1e-1
alpha = density_params.alpha;
...
navigation.grad_density = gradient(navigation.density, [x;t]);
