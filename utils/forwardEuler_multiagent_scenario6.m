function [x_euler, u_euler, x_dot] = forwardEuler_multiagent_scenario3(p, deltaT, ctrl_multiplier, dynamics, gradDensityHandles, c1, c2, c3, c4, c5, c6, dyn_p, x_temp, agent_number, dens_bool)
    ...
    [x_dot, u_euler, isgoal, unicycle] = dynamics(deltaT, x_temp, ctrl_multiplier, gradDensityHandles, c1, c2, c3, c4, c5, c6, p, dyn_p, agent_number, dens_bool);
